...
describe('MfkValidationService', () => {
  ...
  it('#getMfkValidationUrl should produce correct ITS MFK Validation URL', () => {
  ...
  it('#getValidationResult should return expected MFK Validation Result (HttpClient called once)', () => {
    const apiResponse = `1
  Valid MFK`;
